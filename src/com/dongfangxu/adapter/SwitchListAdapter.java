...
public class SwitchListAdapter extends BaseAdapter {
	...
	private SwitchGridAdapter switchGridAdapter ;
	
	public SwitchListAdapter(Context context, List< Map<String, Object>> data) {
		// TODO Auto-generated constructor stub
		 this.mSelfData = data;  
	     this.mLayoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);  
	     switchGridAdapter = new SwitchGridAdapter(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(position>=mSelfData.size())
			return null;
		if(convertView==null){
			convertView=mLayoutInflater.inflate(R.layout.switch_grid_info, null);
		}
		...
		switchGridAdapter.setArrayList(arrayList);
		myGridView.setAdapter(switchGridAdapter);
